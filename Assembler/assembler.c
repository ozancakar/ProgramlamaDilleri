...
int charsToIntForLiteral(char arr[]) 
{
...
int charsToIntForRamAddress(char arr[]) //RAM hesaplama
{
...
int stringControl(char string1[], char string2[]) 
{
...
int statusRegisterContoller(short x) // Status Register
{
    if (x == 0) // 0 eşitse 0
    {
        return 0;
...
void intToBinaryConverter(int x) 
{
...
void printRawLetterData(int size, char arr[]) 
{
    int i;
    printf("Harf Hali : \n");
...
void printTokenizedMatrix(int R, int C, char M[R][C]) // Tokenizer
{
    int i, j;
